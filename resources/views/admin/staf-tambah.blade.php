...
@section('content')
    ...
    <div>
        <form action="/staf-add" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mt-5 w-50">
            ...
            <div class="mt-3 w-50">
                ...
                <input type="bidang" name="bidang" id="bidang" class="form-control @error('bidang') is-invalid @enderror" placeholder="bidang">
                @error('bidang')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
